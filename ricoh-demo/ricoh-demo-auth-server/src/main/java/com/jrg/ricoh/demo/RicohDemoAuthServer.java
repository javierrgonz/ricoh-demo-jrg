...
public class RicohDemoAuthServer {

	public static Logger LOGGER = LoggerFactory.getLogger(RicohDemoAuthServer.class);

    public static void main(String[] args) {
	try {
	    SpringApplication.run(RicohDemoAuthServer.class, args);
	} catch (Throwable e) {
